...
tasks.register("runApp", Exec::class) {
    ...
    if (localProperties.exists()) {
        ...
        val applicationPackage = "me.loterio.movie.app.${Default.BUILD_FLAVOR}.${Default.BUILD_TYPE}"
        val launchActivity = "me.loterio.movie.app.core.navigation.RouteActivity"
